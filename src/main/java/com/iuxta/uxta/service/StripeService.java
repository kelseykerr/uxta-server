...
//                ExternalAccountCollection Neacs = account.getExternalAccounts();
//                if (eacs != null) {
...
//            LOGGER.error(msg);
//            throw new com.iuxta.uxta.exception.IllegalArgumentException(msg);
//        }
...
//            LOGGER.error("Cannot add payment destination for user" + UxtaUtils.getUserIdString(user) +
...
//        verifyAllParametersPresent(user);
//        if (!user.getTosAccepted()) {
//            LOGGER.error("Cannot add payment details for user" + UxtaUtils.getUserIdString(user) +
//                    "because the terms of service has not been accepted");
//            throw new NotAllowedException("You must accept the terms of service");
//        }
...
//            LOGGER.error("Cannot add destination for user" + UxtaUtils.getUserIdString(user) + error);
